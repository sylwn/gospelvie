...
?>
	...
	<div class="main">
		<div class="inner_main">
			...
			<?php $ds_alpha = stripslashes(get_post_meta($post->ID, "ds_alpha", true)); if (!empty($ds_alpha)) {echo '<div class="container_alpha slogan" style="text-align: center;">'.$ds_alpha.'</div>';} ?>
