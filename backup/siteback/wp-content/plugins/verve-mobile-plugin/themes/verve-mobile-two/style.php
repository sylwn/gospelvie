...
$verve_default_options['images'] = array(
	"custom_website_background"=>"images/bg-transparent.gif",
);
...
section {
	...
	.secHead {
		...
		background: url(images/icon-sec-arrow.png) no-repeat 98% 50%, -webkit-gradient(linear, left top, left bottom, color-stop(0%,#4c4c4c), color-stop(54%,#2c2c2c), color-stop(100%,#131313)); 		
		
		background: url(images/icon-sec-arrow.png) no-repeat 98% 50%, -webkit-linear-gradient(top, #4c4c4c 0%,#2c2c2c 54%,#131313 100%); 
		
		
		background: url(images/icon-sec-arrow.png) no-repeat 98% 50%, -moz-linear-gradient(top, #4c4c4c 0%, #2c2c2c 54%, #131313 100%);		
		
		
		background: url(images/icon-sec-arrow.png) no-repeat 98% 50%, -o-linear-gradient(top, #4c4c4c 0%,#2c2c2c 54%,#131313 100%); 		
		
		
	background: linear-gradient(top, #4c4c4c 0%,#2c2c2c 54%,#131313 100%);
	background: -ms-linear-gradient(top, #4c4c4c 0%,#2c2c2c 54%,#131313 100%); 			
	}
