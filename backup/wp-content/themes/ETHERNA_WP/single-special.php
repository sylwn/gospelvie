...
?>
	...
	<div class="main">
		...
		<?php if($ds_eth_single_alpha2){echo '<div class="container_alpha slogan">'.stripslashes($ds_eth_single_alpha2).'</div>';}
		...
		<?php } ?>
			<div class="container_omega blogpage">
				<?php if($ds_eth_single_sidebar_left2 != 0){ ?>
				<ul class="gs_<?php echo($ds_eth_single_sidebar_left2); ?> sidebar_mirror">
					<?php if(function_exists(dynamic_sidebar(5))):
					dynamic_sidebar(5);
					endif; ?>
				</ul>
				<?php } ?>
				<div class="gs_<?php echo(12-$ds_eth_single_sidebar_right2-$ds_eth_single_sidebar_left2); ?> <?php if($ds_eth_single_sidebar_right2 == 0){echo 'omega';} ?>">
					<?php if (have_posts()) : ?>
					<?php while (have_posts()) : the_post(); ?>
					<?php
					$picsize_x = ((((12-$ds_eth_single_sidebar_right2-$ds_eth_single_sidebar_left2)-1)*77)+33);
				...
				<?php if($ds_eth_single_sidebar_right2 != 0){ ?>
				<ul class="gs_<?php echo($ds_eth_single_sidebar_right2); ?> sidebar omega">
					<?php if(function_exists(dynamic_sidebar(6))):
					dynamic_sidebar(6);
					endif; ?>
				</ul>
				<?php } ?>
